...
*/
#ifndef CLASSIFYINFERENCETHREAD_H
#define CLASSIFYINFERENCETHREAD_H
#pragma once
...
/**
* ClassifyInferenceThread
*/
class ClassifyInferenceThread : public AclLiteThread {
public:
    ClassifyInferenceThread(std::string modelPath);
    ~ClassifyInferenceThread();
    AclLiteError Init();
